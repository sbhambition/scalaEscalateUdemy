...
//Initializing list using cons and nil

val moreNums = 1::2::3::Nil


//
//Converting list arrays
//lists are immutable , arrays are not
List(1,2,3).toArray
Array(4,5,6,7).toList

val oneTwoThree = 1::threeFour
val zeroThreeFour = 0::threeFour

val anotherOneTwoThree = 1:: threeFour
oneTwoThree == anotherOneTwoThree
oneTwoThree.eq(anotherOneTwoThree)
